...
const allProjects = [
  { title: '[upcoming] Indo-English Translation Machine', description: 'A mini Indonesian-English translation machine built from scratch.', tags: ['Python', 'PyTorch', 'NLP', 'AI'], github: 'https://github.com/nabilrakaiza/id-en-translator', live: '/playground/id-en-translator', accent: '#ff6b6b', category: 'AI Systems' },
  { title: '[upcoming] Fairy Chess Machine', description: 'Implementation of minimax + alpha-beta pruning to play fairy chess.', tags: ['Python', 'Classical AI', 'Adversarial Search'], live: '/playground/fairy-chess-machine', accent: '#ff6b6b', category: 'AI Systems' },
