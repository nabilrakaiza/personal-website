...
const rawContent = `Lecturer: Prof. Vik Gopal
...
Prof decided to use Microsoft Teams as the main communication platform, which I had no complain about. He will definitely provide the recording, but his lectures are just so calming I'd actually come for it. He also touched on some extra information such as some statistical methods that might be useful for further modules. It's a good idea to graze on these so as to give us awareness of their existence, e.g. how does the loess method work, instead of just using it in lm's method. He also has a website that basically displays his code live, and we can comment on the code that he's currently explaining or copying them for easy reference and learning. It's just such easy to work around with these.

**Tutorials - 1h**

Basically, for every week, there will be a tutorial worksheet released to be done in a week by submitting Rmd files (R markdown). As someone who's been familiar with GitHub Markdown files, I had no trouble familiarizing myself with Rmd files, but learning this becomes crucial when you have to always submit everything in this file format. The one-hour session is to simply discuss about these problems for you as a help to solve these questions. It is also recorded. Personally, the questions take a while to solve (at least 3 hours?) but I enjoy exploring these datasets provided beforehand. There's actually more insights you can gain the moment you explore them.
    ...
    return (
      <div className="bg-gray-900 min-h-screen text-white font-sans">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-white mb-8 text-2xl"><b>DSA2101: Essential Data Analytics Tools: Data Visualisation </b></p>
            {/* Main Content */}
            <main className="py-3">
