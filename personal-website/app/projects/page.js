        ...
        <main className="py-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-amber-300 p-6 rounded-4xl hover:shadow-lg transition-shadow">
              <img src = "./sample-foto.png" alt="Project Image" className="w-full h-36 object-cover rounded-4xl mb-4"/>
              ...
              <div className="flex w-full gap-4">
                {/* <img src = "./github-logo.svg" alt="GitHub Logo" className="w-6 h-6 mb-4"/> */}
                <img src = "./youtube-logo.webp" alt="YouTube Logo" className="w-6 h-6 mb-4"/>
                <img src = "./Book open.png" alt="Doc Logo" className="w-6 h-6 mb-4"/>
              </div>
            </div>
            <div className="bg-amber-300 p-6 rounded-4xl hover:shadow-lg transition-shadow">
              <img src = "./sample-foto.png" alt="Project Image" className="w-full h-36 object-cover rounded-4xl mb-4"/>
