        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <header className="flex justify-between items-center py-6">
            ...
            <nav className="bg-gray-800 px-4 py-2 rounded-full flex items-center space-x-2">
              ...
              <NavLink href="#" active>Blogs</NavLink>
            ...
            <main className="py-3">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-amber-300 p-6 rounded-4xl hover:shadow-lg transition-shadow">
                        ...
                        still accept it! Then for the rest of the mods, I honestly doesn't really care on the grade that I will get since I have 5 SU 
                        left to use.</p>
